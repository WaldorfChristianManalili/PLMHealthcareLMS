        ...
        <div class="container-fluid my-4 justify-content-center">
            <div class="container d-flex bg-body-tertiary mb-3 mx-0 p-2 rounded-3">
                <div class="col text-uppercase pt-1 px-2">
                    <h4 style="font-weight: 800; color: #fff;"><i class="bi bi-pencil-square me-2"></i> edit school year</h4>
                </div>
                <a href="admin_school_year.php">
            ...
            <div class="container bg-body-tertiary rounded-3 p-3">
                <?php
                $query = mysqli_query($conn, "SELECT * FROM school_year WHERE school_year_id = '$get_id'") or die(mysqli_error($conn));
                ...
                <form method="post" id="edit_class">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input class="form-control" type="text" value="<?php echo $row['school_year']; ?>" name="school_year" required></input>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#edit_class').submit(function(e) {
                ...
                $.ajax({
                    url: 'admin_edit_school_year_save.php<?php echo '?id=' . $get_id; ?>', // Replace with your AJAX handler URL
                    type: 'POST',
