                        ...
                        <div class="container justify-content-sm-center">
                            <div class="row justify-content-center p-3">
                                <div class="btn-group position-relative" role="group" aria-label="Message Navigation">
                                    <a class="btn btn-outline-primary" href="teacher_message.php"><i class="bi bi-envelope-fill"></i> Inbox</a>
                                    ...
                                    <?php } ?>
                                    <a class="btn btn-outline-primary active" href="teacher_message_sent.php"><i class="bi bi-envelope-fill"></i> Sent messages</a>
                                </div>
