    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-uppercase fw-bold" aria-current="page" href="student_notification.php<?php echo '?id=' . $get_id; ?>"><i class="bi bi-bell-fill" style="font-size: 20px;"></i>
                        <?php if ($not_read == '0') {
                        } else { ?>
                            <span class="position-absolute translate-middle p-2 bg-danger border border-light rounded-circle" style="z-index: 1;"></span>
                        <?php } ?>
                    </a>
                </li>
