        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-uppercase fw-bold active" aria-current="page" href="student_progress.php<?php echo '?id=' . $get_id; ?>">GRADES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-uppercase fw-bold" aria-current="page" href="student_announcements.php<?php echo '?id=' . $get_id; ?>">announcements</a>
                    </li>
                    <li class="nav-item">
                        <?php
                        ...
                        ?>
                        <a class="nav-link text-uppercase fw-bold" aria-current="page" href="student_social.php<?php echo '?id=' . $get_id; ?>">messages
