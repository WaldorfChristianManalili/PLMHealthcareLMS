                        ...
                        <div class="container justify-content-sm-center">
                            <div class="row justify-content-center">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="teacher_message.php">For Teacher</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="teacher_message_send.php">For Student</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <select name="student_id" class="form-select" required>
                                                ...
                                                <?php
                                                $query = mysqli_query($conn, "SELECT * FROM student ORDER BY firstname");
