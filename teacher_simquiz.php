                            ...
                            <div class="row justify-content-center p-3">
                                <div class="container justify-content-sm-center">
                                    <div class="row justify-content-center">
                                        <?php
                                        $query = mysqli_query($conn, "select class_quiz_id, teacher_class_id, quiz_time, class_quiz.quiz_id,  class_quiz.date_added, quiz_title, quiz_description, teacher_id FROM class_quiz 
										...
										order by date_added DESC ") or die(mysqli_error($conn));
                                                        ...
                                                        ?>
                                                            <tr class="message-box" id="del<?php echo $id; ?>">
                                                                ...
                                                                <td>
                                                                    <a href="teacher_view_quiz_score.php<?php echo '?id=' . $get_id ?>&<?php echo 'post_id=' . $id ?>" data-placement="bottom" title="View Simulation Score" id="<?php echo $id; ?>view" class="btn btn-success"><i class="bi bi-folder-fill"></i></a>
                                                                    <a class="btn btn-danger remove-message" title="Delete" data-message-id="<?php echo $id; ?>" data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-trash3-fill"></i>
