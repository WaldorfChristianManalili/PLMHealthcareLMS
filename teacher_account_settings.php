...
<body>
    <?php include('navbar_teacher_account.php'); ?>
                    ...
                    <div class="container justify-content-sm-center">
                        <div class="row justify-content-center">
                            ...
                            <div class="mb-3 ps-4 pb-2">
                                <button data-bs-toggle="modal" data-bs-target="#myModal_teacher" type="submit" class="btn btn-info"><i class="bi bi-image"></i> Change Account Picture</button>
                                <?php include('teacher_avatar_modal.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#change_password').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'teacher_update_password.php',
                    data: {
