        ...
        <div class="container mx-auto">
            ...
            WHERE message.reciever_id = '$session_id' ORDER BY date_sended DESC") or die(mysqli_error($conn));
                    ...
                    <div class="container justify-content-sm-center">
                        <div class="row justify-content-center">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link" href="student_social.php<?php echo '?id=' . $get_id; ?>">For Teacher</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="student_social_send.php<?php echo '?id=' . $get_id; ?>">For Student</a>
                                </li>
                            </ul>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="student_id" class="form-select" required>
                                            <option value="" disabled selected class="text-muted">Select Student</option>
                                            <?php
                                            $query = mysqli_query($conn, "SELECT * FROM student WHERE student_id != '$session_id' ORDER BY firstname ASC");
                ...
                <div class="container bg-body rounded-3 justify-content-center align-items-center p-0 mt-3" style="overflow-y: auto; height: 550px; max-height: 550px;">
                    ...
                    <div class="container row row-cols-5justify-content-sm-center">
                        <?php
                        $my_student = mysqli_query($conn, "SELECT * FROM teacher_class_student
                                    LEFT JOIN student ON student.student_id = teacher_class_student.student_id
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#send_message', function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "student_send_message_2.php",
                    data: formData,
                    cache: false,
                    success: function(response) {
                        // Handle the success response
