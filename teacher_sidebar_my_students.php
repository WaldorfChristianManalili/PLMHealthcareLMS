<div class="sidebar flex-column flex-shrink-0 p-3 bg-body-tertiary" tabindex="-1" id="sidebarCollapse" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="teacher_my_students.php<?php echo '?id=' . $get_id; ?>" class="nav-link active" aria-current="page">
        ...
        <li>
            <a href="teacher_demonstration.php<?php echo '?id=' . $get_id; ?>" class="nav-link link-body-emphasis">
